...
export const metadata: Metadata = {
  title: "Terms & Conditions - Imaiger",
  description:
          ...
          <div className="flex flex-wrap  items-center justify-center o-hidden">
            <div className="sm:w-3/4 pr-4 pl-4">
              ...
              <p className="text-xl font-light">
                ...
                page outlines everything you need to know prior to using our
          ...
          <div className="flex flex-wrap  justify-center">
            <div className="sm:w-3/4 pr-4 pl-4">
              ...
              <p className="text-xl font-light mb-4">
                ...
                understood as the &quot;Company&quot; or &quot;Brand&quot; or
                &quot;Website&quot; or &quot;App&quot;), govern your use of this
                website, including all pages within this website and app
                (collectively referred to herein below as this
                &ldquo;Website&rdquo;). These Terms apply in full force and
              ...
              <p className="text-xl font-light mb-4">
                ...
                respect to Your Content, by displaying it, you grant Imaiger a
              ...
              <p className="text-xl font-light mb-4">
                ...
                liability is under contract, tort or otherwise, and Imaiger,
              ...
              <p className="text-xl font-light mb-4">
                ...
                attorney&rsquo;s fees) arising out of or in any way related to
